  ...
  return (
    <div className="flex-1 p-6 lg:p-8 pt-20 lg:pt-8 overflow-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400 mt-0.5">{total} total bookings — full edit and delete access</p>
      </div>
                  ...
                  return (
                    <motion.tr key={b._id}
                      ...
                      <td className="px-4 py-3">
                        ...
                        {b.driver && <p className="text-xs text-gray-400">{b.driver.name}</p>}
                      </td>
                      ...
                      <td className="px-4 py-3">
                        {confirmId === b._id ? (
                          ...
                          <div className="flex gap-2">
                            <Link href={`/admin/bookings/${b.bookingId}`}
                            ...
                            <button type="button" onClick={() => setConfirmId(b._id)}
