...
export default function EditPlacePage() {
  ...
  if (!form) return (
    <div className="flex-1 p-8 pt-20 lg:pt-8 text-center">
      ...
      <p className="text-gray-600 dark:text-gray-400">Place not found.</p>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <button type="button"
                ...
                className="relative w-10 h-5 rounded-full overflow-hidden transition-all duration-200 mt-0.5"
