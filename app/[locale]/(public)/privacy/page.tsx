...
const SECTIONS = [
  ...
  {
    title: '5. Cookies, Local Storage & Visitor Tracking',
    content: 'We use cookies, browser local storage, and session storage to:',
    list: [
      'Keep you signed in to your account across sessions (authentication cookie — essential)',
      'Remember your language and theme preference across visits',
      'Assign an anonymous visitor ID (stored in your browser\'s local storage) to count unique visitors without identifying you',
      'Record which pages you visit, your device type, browser, operating system, and approximate country — purely for analytics purposes',
      'Measure time spent on each page to understand which content is most useful',
      'Track the source that brought you to our website (referrer URL, UTM parameters from links you click)',
    ],
    footer: [
      'Visitor Tracking (Privacy-Safe): When you visit any public page on our website, we log an anonymous record that includes: the page URL, a randomly generated visitor ID (not linked to your personal identity), your device category (desktop/mobile/tablet), browser name, operating system, and your country (derived from your IP address — we hash the IP immediately and never store it in raw form). This data is automatically deleted after 90 days.',
      'No Advertising Tracking: We do not use tracking pixels, ad networks, or cross-site tracking cookies. Your browsing on other websites is never monitored by us.',
      'Your Control: You can clear your browser\'s local storage at any time to reset your visitor ID. You can also disable cookies in your browser settings, though this may prevent you from logging in. Disabling cookies or local storage does not prevent our server-side anonymous analytics, but that data contains no personal identifiers.',
    ].join(' '),
  },
  {
  ...
  },
  {
    ...
    list: [
      ...
      'Anonymous visitor analytics logs are automatically deleted after 90 days (enforced at the database level via a TTL index).',
      'When personal data is deleted upon request, it is permanently removed from our systems within 30 days.',
    ],
  },
  {
    title: '8. Your Rights',
