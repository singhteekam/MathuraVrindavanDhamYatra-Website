              ...
              <AnimatePresence>
                {showFilters && (
                  <motion.div
                    ...
                    className="absolute left-0 sm:left-auto sm:right-0 top-full mt-2 w-48 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 py-2 z-30"
                  >
                    {CITIES.map((city) => (
                      <button
                        key={city.slug}
              ...
              <AnimatePresence>
                {showSort && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 6, scale: 0.98 }}
                    transition={{ duration: 0.15 }}
                    className="absolute left-0 sm:left-auto sm:right-0 top-full mt-2 w-52 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 py-2 z-30"
                  >
